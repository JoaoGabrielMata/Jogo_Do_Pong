...
function iniciarJogo() {
    ...
    while(escolha_da_dificuldade==false){// escolha da dificuldade
        ...
        if(dificuldade>0 && dificuldade<10){
            ...
            velocidadeOponente=velocidadeOponente*dificuldade
...
// function CimaOponente(e) {
//     if (e.keyCode == 	79) {
//         Cima_Oponente = false;
//     } else if (e.keyCode == 76) {
//         Baixo_Oponente = false;
//     }
// }
// function BaixoOponente (e) {
//     if (e.keyCode == 	79) {
//         Cima_Oponente = true;
//     } else if (e.keyCode == 76) {
//         Baixo_Oponente = true;
...
function loopGame() {
   ...
   context.fill();
    ...
    // if (Cima_Oponente != Baixo_Oponente) { // se o usuário precionar para cima
    //     if (Cima_Oponente) { // se for para cima pressionado
    ...
    if (pontosA==10 || pontosB==10) {
        alert ("O de hoje tá Ganho")
    }
    context.font = "38pt Arial"; // tamanho e fonte
    context.fillStyle = "#FFFF00"; //Seleciona a cor
...
var Som = new Audio ('TrilhaSonora.mp3');
/****************************** FUNÇÃO DO JQUERY *****************************/ 
$(function () {
    iniciarJogo();
});